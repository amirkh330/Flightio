                                      ...
                                      <td style="line-height: 24px; font-size: 16px; margin: 0;" align="left">
                                        ...
                                        <table class="ax-center" role="presentation" align="center" border="0" cellpadding="0" cellspacing="0" style="margin: 0 auto;">
                                          <tbody>
                                            <tr>
                                              <td style="line-height: 24px; font-size: 16px; margin: 0;" align="left">
                                                <img class="w-32" src="https://takhfife.com/wp-content/uploads/2020/09/flightio-com-logo-300x300.png" style="height: auto; line-height: 100%; outline: none; text-decoration: none; display: block; width: 128px; border: 0 none;" width="128">
                                              </td>
                                            </tr>
                                          </tbody>
                                        </table>
                                            ...
                                            <tr>
                                              <td style="line-height: 24px; font-size: 16px; margin: 0;" align="left">
                                                <h1 class="text-white text-center" style="color: #ffffff; padding-top: 0; padding-bottom: 0; font-weight: 500; vertical-align: baseline; font-size: 36px; line-height: 43.2px; margin: 0;" align="center">
                                                    هشدار، اتمام تاریخ اعتبار قرارداد</h1>
                                              </td>
                                            </tr>
                                          </tbody>
                                        </table>
                                          ...
                                          <tbody>
                                            <tr>
                                              <td style="line-height: 24px; font-size: 16px; margin: 0;" align="left">
                                                ...
                                                <br>
                                                یادآورمیشویم قرارداد <b>شرکت ${item} </b> به زودی منقضی خواهد شده، لطفا در اسرع وقت رسیدگی بفرمایید
                                                </p>
                                              </td>
                                            </tr>
                                          </tbody>
                                          ...
                                          <tbody>
                                            <tr>
                                              <td style="line-height: 24px; font-size: 16px; border-radius: 9999px; width: 320px; font-weight: 800 !important; margin: 0;" align="center" bgcolor="#ffda6a" width="320">
                                                <a href="https://docs.google.com/spreadsheets/d/18EE84SjkM91ate4AMEOFIFY_nXuIEF1ue46WI4GUahY/edit#gid=0" style="color: #111111; font-size: 16px; font-family: Helvetica, Arial, sans-serif; text-decoration: none; border-radius: 9999px; line-height: 20px; display: inline-block; font-weight: 800 !important; white-space: nowrap; background-color: #ffda6a; padding: 16px 12px; border: 1px solid #ffda6a;">چک کردن جدول اطلاعات</a>
                                              </td>
                                            </tr>
                                          </tbody>
                                        </table>
